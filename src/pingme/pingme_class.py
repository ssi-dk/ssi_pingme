...
@staticmethod
def resolved_payload(template: json, context: dict) -> dict:
    """
...
class PingMe:
    ...
    def __init__(self, card: Card, config_file=None):  # Extension of card file
        ...
        Args:
            card (str): Card, the card to be sent
            config_file (str): str, the path to the config file
        """
